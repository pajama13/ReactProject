...
function CarList(){
    ...
    let html=carList.map((car,index)=>
        <li className={index%4==0?'one_quarter first':'one_quarter'} style={{"boxShadow":"0 2px 10px rgba(0,0,0,0.3","padding":"15px"}}>
            <NavLink to={"/jeju/car_detail/"+car.carno}>
                <img src={car.car_IMAGE}/>
                <p style={{"textAlign":"center"}}>{car.car_NAME}</p>
            </NavLink>
        </li>
    )
    let row=[]
        ...
        <div className="wrapper row3">
            <main className="hoc container clear">
                <div className="content">
                    <div id="gallery">
                        <figure>
                            <header className="heading">렌트카 타고 제주를 즐겨봐요!</header>
